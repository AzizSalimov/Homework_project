...
#
# from ffff.Glass.Hoework2.Homewok1 import inputFiled
# from hotelinfo import Hotel
# import tkinter as tk
# from tkinter import messagebox, END, Label, Entry, StringVar, Radiobutton, Button
...
#
# rooms = StringVar()
# rooms_ = {'Standart': '500$', 'Luxy': '1000$', 'Biznes': '2000$'}
# age_ = Label(window, text='Age info:')
# age_.place(x=250, y=36)
# age__ = Entry(window, width=30, borderwidth=3)
# age__.place(x=300, y=60)
#
# price = Label(window, text='Room price:', padx=20, pady=10)
# price.grid(row=40, column=2)
#
#
#
#
# # age___ = Button(window, text='Age', padx=20, pady=10, command=age)
# # age___.place(x=360, y=340)
#
#
#
...
room_1 = IntVar()
Checkbutton(window, text='room_1', variable=room_1).grid(row=0, sticky=E)
...
button = Button(window, text='400$', bg='gray', fg='white')
button.place(x=160, y=280)

bu = Button(window, text='1000$', bg='gray', fg='white')
